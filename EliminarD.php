...
<html lang="en">
  ...
  <body>
    ...
    <br>
    <br>
    <center><h1 class="logo">¿Seguro que Deseas Eliminar este Departamento?</h1></center>
    <div class="content">
      <div class="contact-wrapper">
        <div class="contact-form">
          <h3>Eliminar</h3>
          <form class="reform" action="controlador.php" method="post">
            <input name="id" type="hidden" value="<?php echo $_REQUEST['id'];?>" required>
            <p>
              <label for="">Usuario:</label>
            </p>
            <p>
              <input name="namedep" type="text" value="<?php echo $_REQUEST['nomd'];?>" required>
            </p>
            <p>
              <button name="eliminard" type='submit' id='btm' class='btn btn-success'>Confirmar</button>
              <a href="ConDep.php" name="btnRegresar" type='button' class='btn btn-danger'>Cancelar</a>
            </p>
          </form>
        </div>
      </div>
