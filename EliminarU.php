...
<html lang="en">
  ...
  <body>
    ...
    <br>
    <br>
    <center><h1 class="logo">¿Seguro que Deseas Eliminar a Este Usuario?</h1></center>
    <div class="content">
      <div class="contact-wrapper">
        <div class="contact-form">
          ...
          <form class="reform" action="controlador.php" method="post">
            ...
            <p>
              <input name="name" type="text" value="<?php echo $_REQUEST['nomu'];?>" required>
            </p>
            <p>
              <button name="eliminar" type='submit' id='btm' class='btn btn-success'>Confirmar</button>
              <a href="ConUser.php" name="btnRegresar" type='button' class='btn btn-danger'>Cancelar</a>
            </p>
          </form>
        </div>
      </div>
