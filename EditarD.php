...
<html lang="en">
  ...
  <body>
    ...
    <br>
    <div>
      <center><h1 class="logo">Editar Departamento</h1></center>
      <div class="content">
          ...
          <div class="contact-form">
            <form class="reform" action="controlador.php" method="post">
              <p>
                ...
                <input name="namedep" type="text" value="<?php echo $_REQUEST['nomd'];?>" require>
              </p>
              <p>
                <label><b>Area del Departamento:</b></label>
                <input name="aread" type="text" value="<?php echo $_REQUEST['area'];?>" required>
              </p>
              <p>
                <label><b>Auxiliar Acargo:</b></label>
                <input name="auxdep" type="text" value="<?php echo $_REQUEST['aux'];?>" required>
              </p>
              <p class="block">
                <button name="editd" type="submit" id="btm" class="btn btn-light">Actualizar</button>
              </p>
            </form>
          </div>
        </div>
